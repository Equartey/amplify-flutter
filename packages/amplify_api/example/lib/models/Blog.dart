...
class Blog extends Model {
  ...
  const Blog._internal({required this.id, required name, createdAt, posts}): _name = name, _createdAt = createdAt, _posts = posts;
  
  factory Blog({String? id, required String name, TemporalDateTime? createdAt, List<Post>? posts}) {
  ...
  Blog copyWith({String? id, String? name, TemporalDateTime? createdAt, List<Post>? posts}) {
    return Blog(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'createdAt': _createdAt?.format(), 'posts': _posts?.map((e) => e?.toJson())?.toList()
  };
